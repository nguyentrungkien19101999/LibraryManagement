...
public class History_BorrowFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_history_borrow, container, false);
        ...
        bookHelper.QueryData("CREATE VIEW IF NOT EXISTS datra_VIEW AS SELECT * FROM MuonSach WHERE NgayTra not NULL");
    ...
    private void select2() {
        mangMuonSach.clear();
        Cursor cursor = bookHelper.GetData("SELECT * FROM MuonSach WHERE NgayTra not null");
    ...
    private void dialogSearch_Lichsu(){
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(search)){
                    ...
                    mangMuonSach.clear();
                    Cursor cursor = bookHelper.GetData("SELECT * FROM datra_VIEW WHERE TenSV like '%"+search+"%' or MaSach like '%"+search+"%' or MaSV like '%"+search+"%' or NgayMuon like '%"+search+"%'");
                    while (cursor.moveToNext()) {
                        int id = cursor.getInt(0);
                        String MaSV = cursor.getString(1);
                        String MaSach = cursor.getString(2);
